...
export const DEFAULT_GIFT_OPTIONS: GiftOptions = {
  relationships: [
    { value: "lover", label: "연인", description: "취향과 감성이 모두 중요한 관계" },
    { value: "friend", label: "친구", description: "부담 없이 마음을 전하는 사이" },
    { value: "parent", label: "부모님", description: "실용성과 정성이 함께 필요한 관계" },
    { value: "sibling", label: "형제/자매", description: "가깝지만 취향을 놓치기 쉬운 관계" },
    { value: "coworker", label: "동료", description: "센스 있고 과하지 않은 선물이 필요한 관계" },
    { value: "teacher", label: "선생님/멘토", description: "감사와 예의를 담아야 하는 관계" },
  ],
  genders: [
  ...
  hobbies: [
    { value: "any", label: "상관없음" },
    { value: "coffee", label: "커피/차" },
    { value: "reading", label: "독서" },
    { value: "beauty", label: "뷰티/향기" },
  ...
  occasions: [
    { value: "birthday", label: "생일", description: "가장 안전하지만 기억에 남아야 하는 날" },
    { value: "anniversary", label: "기념일", description: "관계의 결을 보여주는 날" },
    { value: "graduation", label: "졸업/합격", description: "새 출발을 응원하는 날" },
    { value: "housewarming", label: "집들이", description: "공간에 오래 남는 선물" },
    { value: "thanks", label: "감사", description: "말로 부족한 고마움을 전하는 날" },
    { value: "cheering", label: "응원/위로", description: "힘을 보태고 싶은 순간" },
    { value: "holiday", label: "명절/시즌", description: "예의를 갖춘 계절 선물" },
  ],
  giftTones: [
    { value: "warm", label: "따뜻한" },
    { value: "practical", label: "실용적인" },
    { value: "premium", label: "고급스러운" },
    { value: "cute", label: "귀여운" },
    { value: "surprising", label: "의외성 있는" },
    { value: "calm", label: "차분한" },
  ],
  budgetRanges: [
    { value: "under_30000", label: "3만원 이하", min: 0, max: 30000, display: "~ 30,000원" },
    { value: "30000_50000", label: "3만~5만원", min: 30000, max: 50000, display: "30,000 ~ 50,000원" },
    { value: "50000_100000", label: "5만~10만원", min: 50000, max: 100000, display: "50,000 ~ 100,000원" },
    { value: "100000_200000", label: "10만~20만원", min: 100000, max: 200000, display: "100,000 ~ 200,000원" },
    { value: "over_200000", label: "20만원 이상", min: 200000, max: null, display: "200,000원 이상" },
  ],
};
...
export function buildRecommendationPayload(
  ...
  return {
    ...
    hobbies,
    budget_range: values.budgetRange || budget.label,
